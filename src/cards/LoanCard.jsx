...
const LoanCard = ({ loan, getLoanStatus, recordPayment, sendReminder }) => {
  ...
  return colors[randomIndex];
     ...
     const firstLetter = loan.borrowerName ? loan.borrowerName.charAt(0).toUpperCase() : '?';
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center ${randomColorClass} text-white font-bold text-lg`}
            >
              {firstLetter}
            </div>
            <div>
                  ...
                  >
                    ...
                    <span
                      className={`font-semibold ${
                        paymentInThisMonth ? "text-green-600" : "text-red-600"
                      }`}
                    >
